...
class config():
    ...
    def __init__(self, controller):
        ...
        #Piece
        self.image.append(PhotoImage(file="build/assets/piece/yellow.png")) #48
        self.image.append(PhotoImage(file="build/assets/piece/green.png")) #49
        self.image.append(PhotoImage(file="build/assets/piece/red.png")) # 50
        self.image.append(PhotoImage(file="build/assets/piece/blue.png")) # 51
